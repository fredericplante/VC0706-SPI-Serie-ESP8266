...
Le developpement se fera en étapes.
  ...
  3. Creer un example qui permettre à un module ESP8266 de piloter la caméra afin de 
  pouvoir récupérer et charger le JPEG vers un port reseau entrant/sortant.
  
  4. Creer un example qui permettre à un module ESP8266 de piloter la caméra afin de 
